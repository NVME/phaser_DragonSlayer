...
export class Loader {
        ...
        for (let image in Assets.Images) {
            if (!this.game.cache.checkImageKey(Assets.Images[image].getName())) {
                for (let option in Assets.Images[image]) {
                    if (option !== 'getName'&& option !== 'getTag') {
    ...
    //                 if (option !== 'getName' && option !== 'getTag' && option !== 'getFrameWidth' && option !== 'getFrameHeight' && option !== 'getFrameMax' && option !== 'getMargin' && option !== 'getSpacing') {
    //                     imageOption = option;
    //                 }
    //             }
